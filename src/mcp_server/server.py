...
async def explain_data(prompt: str, raw_results: list[dict[str, Any]]) -> str:
    ...
    try:
        system_instruction = (
            ...
            "**Data Summary**: Provide a comprehensive, detailed explanation (at least 2-3 paragraphs) analyzing what the numbers show, highlighting key trends, anomalies, and broader business implications.\n"
            ...
            "**Key Takeaway**: Provide multiple actionable business insights derived from the detailed summary.\n\n"
            "Rules: Be specific with numbers from the data. Never say 'the data shows' without citing actual values. Do not be overly brief; the user expects a longer, thorough explanation. "
