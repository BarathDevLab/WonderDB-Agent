...
VALUES
    ('o0010000-0000-0000-0000-000000000001', 'a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a11', 'c0010000-0000-0000-0000-000000000001', 1250.50, 'completed', NOW() - INTERVAL '3 months'),
    ('o0020000-0000-0000-0000-000000000002', 'a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a11', 'c0010000-0000-0000-0000-000000000001', 850.00, 'completed', NOW() - INTERVAL '2 months'),
    ...
    ('o0040000-0000-0000-0000-000000000004', 'a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a11', 'c0030000-0000-0000-0000-000000000003', 450.25, 'pending', NOW() - INTERVAL '5 days')
ON CONFLICT DO NOTHING;
